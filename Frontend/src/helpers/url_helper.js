...
export const NewCustomerApi="/api/new-customer";
export const solvedRep="/api/solved";
export const unSolvedRep="api/unsolved";
export const takenRep="api/taken";
export const itemCostPage="api/itemCost";
